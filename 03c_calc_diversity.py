...
def main(): 
    ...
    parser.add_argument('--agg', '-a', default='/data2/rsalgani/Prefix/ml-1m/agg_files/sample_0', help='Directory containing consensus TXT files')
    ...
    #     cvg['sample'] = sample_name
    #     pct['sample'] = sample_name
    # ipdb.set_trace() 
