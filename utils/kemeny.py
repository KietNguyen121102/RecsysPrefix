...
# ---------- 1) Pairwise matrix from Ranked_Items ----------
...
# ---------- 2) Kemeny objective + fast adjacent-swap delta ----------
...
# ---------- 3) Approx Kemeny solver (Borda init + hill-climb) ----------
...
# ---------- 4) FULL PIPELINE: from dataframe -> Kemeny ranking ----------
...
# Example:
# rankings_df =  pickle.load(open('/data2/rsalgani/Prefix/backup_res/ml-1m/agg_files/sample_0/sampled_rankings.pkl', 'rb'))

# rankings_data = np.array([
#     [0, 1, 2],  # Voter 1: 0 > 1 > 2
#     [1, 0, 2],  # Voter 2: 1 > 0 > 2
#     [2, 1, 0]   # Voter 3: 2 > 1 > 0
# ])

# # Build dataframe in the same format as your real data
# rankings_df= pd.DataFrame({
#     "User_ID": [1, 2, 3],
#     "Ranked_Items": rankings_data.tolist()
# })


# kemeny_order, score, items, W = kemeny_from_dataframe(rankings_df, ranked_items_col="Ranked_Items", restarts=50, seed=0)
# print("Kemeny order (best->worst):", kemeny_order)
# print("Pairwise agreement score:", score)
